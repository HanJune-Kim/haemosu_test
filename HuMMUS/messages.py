...
class descriptions:
	...
	======================================================================	
	  __    __             .___  ___. .___  ___.  __    __       _______.
 	 |  |  |  |  __    __  |   \/   | |   \/   | |  |  |  |     /       |
	 |  |__|  | |  |  |  |\|  .  .  |X|  .  .  |/|  |  |  |    |   (----`
	 |   __   | |  |  |  | |  |\/|  | |  |\/|  | |  |  |  |     \   \    
	 |  |  |  | |  `--'  | |  |  |  | |  |  |  | |  `--'  | .----)   |   
	...
	=======================================================================
	               Human Mouse Microbiome Unraveling Suite

  	  HuMMUS 1.0.0 provided by Bioinformatics Lab. in Yonsei University 	

	  HuMMUS 1.0.0 supports 2 modes following,
	...
	def auto_mode():
		return '''
			...
			================================
		  	     ...
		  	     HuMMUS auto-mode 1.0.0

			================================

	HuMMUS auto-mode 1.0.0 enables users to run general pipelines of MWAS, 
